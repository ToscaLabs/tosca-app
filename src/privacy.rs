...
pub(crate) struct Privacy {
    ...
    usage_description: Cow<'static, str>,
    all_block_description: Cow<'static, str>,
...
impl Privacy {
    pub(crate) fn new(
        ...
        Self {
            ...
            usage: t!("privacy_hazards_card.usage"),
            usage_description: t!("privacy_hazards_card.usage_description"),
            all_block_description: t!("privacy_hazards_card.all_block_description"),
